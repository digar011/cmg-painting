...
import { SERVICE_IMAGES } from '@/lib/projects';
    ...
    <>
      ...
      <main>
        ...
        <section className="py-16 bg-cmg-off-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="relative aspect-[16/9] overflow-hidden rounded-xl bg-cmg-light shadow-glass-md">
              <Image
                src={SERVICE_IMAGES['exterior-painting'].src}
                alt={SERVICE_IMAGES['exterior-painting'].alt}
                fill
